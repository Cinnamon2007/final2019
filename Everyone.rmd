...
From our infurential results we have rejected the nul-hypothis that the drug was ineffictive. The probality of getting the results we obtained if the drug was ineffictive was close to zero. We ended up with a chi-square result of 26 where the exspected result should have been 1. 